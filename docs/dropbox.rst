...
^^^^^^^^^^^^^^^^^^^^^^^^
   ...
   *auth_code* lo obtenemos de acuerdo con el tutorial oficial:
   ...
   Ingresando ésta web en el explorador: https://www.dropbox.com/1/oauth2/authorize?client_id=<app_key>&response_type=code
   
   Cambiando "<app_key>" por la clave que obtenemos en la consola de dropbox

==========  ========================================================================================
 string_     dropbox.get_access_token ( string_ 'app_key', string_ 'app_secret', string_ 'auth_code' );
==========  ========================================================================================
...
==========  ========================================================================================
  table_     dropbox.get_account_info ( string_ 'access_token' )
==========  ========================================================================================
...
.. include:: https://raw.githubusercontent.com/dariocanoh/lide-docs/en_us/directives.rst